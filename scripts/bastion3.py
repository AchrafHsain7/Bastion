...
# Attacker alowed infinite destroy
...
# Attacker Spec: At most 4 destroy
...
class Labeler(LabelingFunction):
        ...
        def labeler_D(self, mdp_state, action, debug=False):
            ...
            # second confition: At least 2 hosts not in Isol/Destroyed
        ...
        def labeler_A(self, mdp_state, action):
            ...
            if mdp_state[-1] == "A": return None
            return ["other"] #infinite Destroy
